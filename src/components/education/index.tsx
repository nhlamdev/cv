      ...
      <div>
        ...
        >
          ...
          <div className='flex flex-col gap-2'>
            <span className='text-sm font-semibold text-slate-100 dark:text-slate-900' style={{ userSelect: 'none' }}>
              Thu Dau Mot university
            </span>
            <span className='text-xs text-slate-100 dark:text-slate-900' style={{ userSelect: 'none' }}>
